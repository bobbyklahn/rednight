...
export const PRODUCTS: Product[] = [
  {
    ...
    priceAUD: parseFloat(process.env.STRIPE_4PACK_PRICE_AUD || '25.00'),
    stripeProductId: 'prod_T9IK63l3Vu75qs',
    stripePriceId: process.env.STRIPE_4PACK_PRICE_ID || 'price_1TDzKGJCURcVFbNLLu3MDyv8',
  ...
  },
  {
    ...
    priceAUD: parseFloat(process.env.STRIPE_SLAB_PRICE_AUD || '150.00'),
    stripeProductId: 'prod_T9LcMtBKaTJPTL',
    stripePriceId: process.env.STRIPE_SLAB_PRICE_ID || 'price_1TDzJHJCURcVFbNLqz3gfjVW',
